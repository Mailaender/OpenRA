	...
	public class GifLoader : ISpriteLoader
	{
		public class GifFrame : ISpriteFrame
		{
			...
			public GifFrame(Stream s, Size size)
			{
				...
				var interlaced = (unpacked & 0x02) != 0;
		...
		bool IsGif(Stream s)
		{
			var magicNumber = s.ReadASCII(6);
			return magicNumber == "GIF87a" || magicNumber == "GIF89a";
		}
			...
			while (true)
			{
				...
				case BlockTypes.ExtensionBlock:
					...
					case BlockTypes.ApplicationExtensionBlock:
						...
						if (lengthA != 11)
							throw new InvalidDataException("Bad app extension");
